...
def main():
    ...
    second_order = False
    print("enable_meta,enable_sigmoid,second_order:",enable_meta,enable_sigmoid,second_order)
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if epoch % 20 == 0:
            torch.save(model.state_dict(), "./models_mmgcl/mmgcl_nometa_" + str(epoch) + ".pth")
